...
namespace NetDemo
{
    public partial class PTZExtend : Form
    {
        ...
        public PTZExtend(NetDemo netDemo)
        {
            ...
            m_iChannelID = netDemo.getCurRealPanel().m_channelIndex + 1;
            m_curRealPlayPanel = netDemo.getCurRealPanel();
            m_curSelectedTreeDeviceIndex = netDemo.m_curSelectedTreeDeviceIndex;
            m_curSelectedTreeChannelIndex = netDemo.m_curSelectedTreeChannelIndex;
        ...
        private void GetPresetID()
        {
            ...
            int iRet = NETDEVSDK.NETDEV_GetDevConfig(m_lpDevHandle, m_iChannelID, (int)NETDEV_CONFIG_COMMAND_E.NETDEV_GET_PTZPRESETS, ref stPtzPresets, Marshal.SizeOf(stPtzPresets), ref dwBytesReturned);
            if(NETDEVSDK.TRUE != iRet)
            {
        ...
        private void PresetPatrolsSaveBtn_Click(object sender, EventArgs e)
        {
            ...
            if(PresetPatrolsIDCobBox.SelectedIndex >= 0)
            {
                ...
                strCruiseInfo.dwCuriseID = m_curSelectedTreeChannelIndex + 1;
